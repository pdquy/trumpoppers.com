...
<head>
        ...
        <title>Trùm Poppers | Gía Trị Đích Thực Trên Từng Sản Phẩm</title>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/uploads/images/website/favicon.jpg')}}">
        ...
        <div class="hotline-phone-ring-wrap">       
            <div class="hotline-phone-ring">
                ...
                <div class="hotline-phone-ring-img-circle"> <a href="tel:0765369013" class="pps-btn-img"> <img src="{{asset('public/uploads/images/website/icon.png')}}" alt="so dien thoai" width="50"> </a></div>
            </div>      
            <div class="hotline-bar"> 
                <a href="tel:0765369013"> <span class="text-hotline">0765 369 013</span> </a>
            </div>
        </div>
        <div class="float-icon-hotline">            
            <ul class ="left-icon hotline">
                <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton" href="https://zalo.me/0765369013"><i class="fa fa-zalo animated infinite tada"></i><span>Zalo</span></a></li>
                <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton" href="https://www.messenger.com/t/trumpoppers"><i class="fa fa-messenger animated infinite tada"></i><span>Facebook</span></a></li>
                <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton" href="mailto:trumpoppers.com@gmail.com"><i class="fa fa-gmail animated infinite tada"></i><span>Gmail</span></a></li>
            </ul>       
        </div>
        <div id="fb-root"></div>
    </head>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span>Đường dây nóng: </span><a href="tel:0765369013">(+84) 0765 369 013</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            <span class="ht-setting-trigger">Kính chào: Quý khách đã đến với trumpoppers.com</span>
                                        </li>
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="{{URL::to('/trang-chu')}}">
                                        <img width="190px" height="45px" src="{{asset('public/uploads/images/website/logo.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="header-middle-right">
                                    <ul class="hm-menu">
                                        ...
                                        <li class="hm-minicart">
                                            <div class="btn btn-danger" style="font-size: 25px;color: red">
                                ...
                                <div class="hb-menu hb-menu-2 d-xl-block">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="{{URL::to('/cong-tac-vien')}}">Cộng tác viên</a></li>
                            ...
                            <div class="category-menu">
                                ...
                                <div id="cate-toggle" class="category-menu-list">
                                    <ul>                                       
                                        ...
                                        <li class="{{ $i>5 ? 'rx-child' : '' }}"><a href="{{url::to('/danh-muc-san-pham/'.$cate->slug_category_product)}}">{{ $cate->category_name}}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        <img width="300 px" src="{{asset('public/uploads/images/website/logo.jpg')}}" alt="trumpoppers.com">
                                        <p class="info" style="text-align: justify;">
                                            trumpoppers.com - Siêu thị trực tuyến số 1 Việt Nam về các sản phẩm poppers, gel bôi trơn, bao cao su và các sản phẩm hỗ trợ sinh lý khác.
                                        </p>
                                    </div>
                                    <ul class="des">
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <a href="tel:0765369013">(+84) 0765 369 013</a>
                                        </li>
                                        <li>
                                            <span>Email: </span>
                                            <a href="mailto://trumpoppers.com@gmail.com">trumpoppers.com@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div style="text-align: center;">
                                            <div class="fb-page" data-href="https://www.facebook.com/fanpagetrumpoppers/" data-tabs="" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/fanpagetrumpoppers/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/fanpagetrumpoppers/">trumpoppers.com</a></blockquote></div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">                                
                                ...
                                <div class="copyright text-center pt-25">
                                    <span><a target="_blank" href="{{url::to('/trang-chu')}}">Bản quyền thuộc về trumpoppers.com</a></span>
                                </div>
            ...
            $(document).ready(function(){
                $('.add-to-cart').click(function(){
                    ...
                    if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                        alert('Làm ơn đặt số lượng nhỏ hơn ' + cart_product_quantity+' sản phẩm.');
                    }else{
