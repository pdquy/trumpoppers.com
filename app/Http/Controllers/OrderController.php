...
class OrderController extends Controller
{
    ...
    public function print_order_convert($checkout_code){
        ...
        <h1><center>TRUMPOPPERS.COM</center></h1>
        <h4><center>GIÁ TRỊ ĐÍCH THỰC TRÊN TỪNG SẢN PHẨM</center></h4>
        <h4><center>-----</center></h4>
        
        <h5><center>hotline-zalo: 0765 369 013 - website: trumpoppers.com</center></h5>
        <h4><center>HÓA ĐƠN BÁN HÀNG</center></h4>
        <p>Thông tin người gửi hàng:</p>
