...
<div class="wrapper">
        ...
        <li class="user-header">
          ...
          <p>
              ...
              <li class="user-footer" style="text-align: center;">
                <div class="pull-left">
                  <a href="{{URL::to('/user-infor')}}">Thông tin tài khoản</a>
                </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{URL::to('/dashboard')}}" class="brand-link">
      <img src="{{asset('public/uploads/images/website/logovuong.jpg')}}" alt="logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span style="color: white" class="brand-text font-weight-light"><strong>TRUMPOPPERS.COM</strong></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header" style="color: orange"> <strong>QUẢN TRỊ WEBSITE</strong></li>
          <li class="nav-item">
          ...
          <li class="nav-header" style="color: orange"><strong>QUẢN TRỊ BÁN HÀNG</strong></li>
          <li class="nav-item">
  ...
  <footer class="main-footer">
    <strong>Bản quyền thuộc về <a href="{{url('trang-chu')}}">trumpoppers.com</a>.</strong>
