...
{	
    ...
    public function contact (Request $request){
    	//SEO
        $meta_desc = "Trùm Poppers - Thế giới poppers chính hãng, giao hành cực nhanh, uy tín, chuyên nghiệp. Thông tin chi tiết liên hệ hotline-zalo: 0765.369.013."; 
        $meta_keywords = "the gioi poppers, thế giới poppers, poppers da nang, poppers đà nẵng, poppers chính hãng, poppers chinh hang, poppers việt nam, poppers viet nam, poppers gia re, poppers giá rẻ, poppers sai gon";
        $meta_title = "Trùm Poppers | Gía Trị Đích Thực Trên Từng Sản Phẩm";
