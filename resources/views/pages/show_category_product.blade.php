                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            @foreach ($category_name as $key =>$cate_id)                          
                            <li class="active">{{$cate_id->category_name}}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 order-1 order-lg-2">
                            ...
                            <div class="single-banner shop-page-banner">
                            	@foreach ($category_name as $key =>$cateid)
                                <a href="#">
                                    <img src="{{ asset('/public/uploads/images/product/'.$cateid->category_image) }}">
                                </a>
                                @endforeach
                            </div>
